...
export default function PricingSectionNavigationsDarkMono1() {
    return (
        <React.Fragment>
            <>
                <section>
  <nav className="relative py-6 bg-gray-900">
    <div className="container mx-auto px-4 flex items-center">
      ...
      <div className="hidden lg:ml-auto lg:block lg:w-1/3 text-right"><a className="hidden lg:inline-block lg:ml-auto lg:mr-3 py-2 px-6 text-sm text-white font-bold border-2 border-gray-800 hover:border-gray-700 rounded-l-xl rounded-t-xl transition duration-200" href="#">Sign In</a><a className="hidden lg:inline-block py-2 px-6 bg-green-500 hover:bg-green-600 text-sm text-white font-bold rounded-l-xl rounded-t-xl transition duration-200" href="#">Sign up</a></div>
      <div className="lg:hidden ml-auto">
        <button className="flex items-center text-white p-3">

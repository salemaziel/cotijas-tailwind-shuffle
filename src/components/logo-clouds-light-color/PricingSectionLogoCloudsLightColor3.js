...
export default function PricingSectionLogoCloudsLightColor3() {
    return (
        <React.Fragment>
            <>
  ...
  <div className="container mx-auto px-4">
    <div className="flex flex-wrap -mx-2">
      <div className="mb-16 lg:mb-0 w-full md:w-1/2 lg:w-1/4 px-2">
        <a href="#">
      ...
      <div className="mb-16 md:mb-0 w-full md:w-1/2 lg:w-1/4 px-2">
        <a href="#">

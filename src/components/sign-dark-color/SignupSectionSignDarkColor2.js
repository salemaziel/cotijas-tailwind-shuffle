...
export default function SignupSectionSignDarkColor2() {
    return (
        <React.Fragment>
            <>
    ...
    <div className="pt-6 lg:pt-16 pb-6 w-full lg:w-1/2">
      <div className="max-w-md mx-auto">
        <div className="mb-6 lg:mb-20 w-full px-3 flex items-center justify-between">
          ...
          <a className="py-2 px-6 text-xs rounded-l-xl rounded-t-xl bg-purple-600 hover:bg-purple-700 text-white font-bold transition duration-200" href="#">Sign Up</a>
        </div>
        <div>
          ...
          <form action>
            <div className="mb-3 flex p-4 mx-3 bg-gray-800 rounded">
            ...
            <div className="mb-6 flex p-4 mx-3 bg-gray-800 rounded">
            ...
            <div className="px-3 text-center">
              <button className="mb-4 w-full py-4 bg-pink-600 hover:bg-pink-700 rounded text-sm font-bold text-gray-50 transition duration-200">Sign In</button>
              <a className="text-xs text-pink-600 hover:underline" href="#">Forgot password?</a>
              <a className="mt-8 mb-4 p-4 flex justify-center items-center border rounded hover:bg-gray-800" href="#">
                <img className="mr-4" src="atis-assets/social/facebook-logo.png" alt />
                <span className="text-xs text-gray-500 font-bold transition duration-200">Sign In with Facebook</span>
              </a>
              <a className="p-4 flex justify-center items-center border rounded hover:bg-gray-800" href="#">
                <img className="mr-4" src="atis-assets/social/google-logo.png" alt />
                <span className="text-xs text-gray-500 font-bold transition duration-200">Sign In with Google</span>
              </a>
            </div>
          </form>
        </div>
    ...
    <div className="hidden lg:block relative w-full lg:w-1/2 bg-purple-600">
      <div className="absolute bottom-0 inset-x-0 mx-auto mb-12 max-w-xl text-center" style={{zIndex: 10}}>
        <div className="overflow-hidden">
          <div className="whitespace-nowrap transition-transform duration-500 ease-in-out">
            <div className="inline-block w-full whitespace-normal">
              <img className="max-w-xl" src="atis-assets/illustrations/pablo-coming-soon-flat-color.png" alt />
            ...
            <div className="inline-block w-full whitespace-normal">
              <img className="max-w-xl" src="atis-assets/illustrations/pablo-coming-soon-flat-color.png" alt />
              <h2 className="mb-2 text-2xl text-white font-bold">Beyond Analytics: Unveiling Business Potential</h2>
              <div className="max-w-lg mx-auto">
                <p className="mb-6 text-gray-50 leading-loose">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque efficitur nisl sodales egestas lobortis.</p>
              </div>
            </div>
            <div className="inline-block w-full whitespace-normal">
              <img className="max-w-xl" src="atis-assets/illustrations/pablo-coming-soon-flat-color.png" alt />
              <h2 className="mb-2 text-2xl text-white font-bold">Data Dynamics: Expanding Business Insights</h2>
              <div className="max-w-lg mx-auto">
                <p className="mb-6 text-gray-50 leading-loose">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque efficitur nisl sodales egestas lobortis.</p>
              </div>
            </div>
            <div className="inline-block w-full whitespace-normal">
              <img className="max-w-xl" src="atis-assets/illustrations/pablo-coming-soon-flat-color.png" alt />
              <h2 className="mb-2 text-2xl text-white font-bold">Analytics Unleashed: Elevating Business Impact</h2>
              <div className="max-w-lg mx-auto">
                <p className="mb-6 text-gray-50 leading-loose">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque efficitur nisl sodales egestas lobortis.</p>
              </div>
            </div>
        ...
        <div className="mt-12 flex justify-center space-x-3">
          ...
          <button className="p-1 rounded-full bg-purple-500" />
          <button className="p-1 rounded-full bg-purple-500" />
          <button className="p-1 rounded-full bg-purple-500" />
        </div>
      </div>
    ...
    <div className="lg:hidden bg-green-600">
      <div className="relative w-full">
        ...
        <div className="flex justify-center space-x-3">
          <button className="p-1 bg-purple-500 rounded-full" />
          <button className="p-1 bg-purple-500 rounded-full" />
